...
#define FILENAME "/home/raspberry/Mars-Rover/firmware/sonar3.txt"
...
static int __init my_init(void) {
	...
	int gpio_stat = gpio_request(534, "rpi-gpio-22");
	if(gpio_stat == -EBUSY)
	{
	printk("ERROR: GPIO 22 is not free. free it or reboot\n");
	return -1;
	}
	if(gpio_stat == -EINVAL)
	{
